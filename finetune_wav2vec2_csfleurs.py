...
def main():
    ...
    print("Downloading CS-FLEURS snapshot (Mandarin-English subset)...")
    ...
    print(f"Total cmn-eng samples: {len(entries)}")
...
# python finetune_wav2vec2_csfleurs.py --output_dir runs/w2v2_csfleurs --num_train_epochs 50 --batch_size 4  --learning_rate 3e-4  --device cuda 
# python finetune_wav2vec2_adapters_csfleurs.py --output_dir runs/w2v2_adapters_csfleurs --num_train_epochs 50 --batch_size 4  --learning_rate 3e-4  --device cuda